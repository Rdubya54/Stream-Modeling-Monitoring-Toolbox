...
##                        arcpy.AddMessage("selecting polygons")
                        ...
                        acpolys_copy=os.path.join(env.workspace,naming+"acpolygons")
                        arcpy.CopyFeatures_management(ac_polygons,acpolys_copy)

                        #load points and polygons into calculate bankfull function
##                        arcpy.AddMessage("calculating bankfull"
                        calculate_bankfull(extracted_points,acpolys_copy)
