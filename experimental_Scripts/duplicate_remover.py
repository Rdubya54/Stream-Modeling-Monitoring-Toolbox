                ...
                if row[1]!=value:
                        ...
                        if value!=0:
                                ...
                                if row[1] in duplicate_list:
                                        ...
                                        try:
                                                working_line=arcpy.MakeFeatureLayer_management(thwag_network_lyr, "workling_points.lyr","oneline_halfm_test2_bufferraster="+str(prev_value)+" AND pointid NOT IN "+mini_dup_list)


                                        except:
                                                arcpy.AddMessage("blank set")
                                                working_line=arcpy.MakeFeatureLayer_management(thwag_network_lyr, "workling_points.lyr","oneline_halfm_test2_bufferraster="+str(prev_value))
                                        mini_dup_list=set()
